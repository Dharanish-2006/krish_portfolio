...
const contactInfo = [
  {
    label: "Business",
    value: "Integrated Business & Digital Services",
    icon: "◈",
  },
  {
    label: "Registration",
  ...
  {
    label: "Founded",
    value: "19 January 2026",
    icon: "◉",
  },
  {
    label: "Service Mode",
    value: "Online / Remote Services",
    icon: "◎",
  },
];
    ...
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 lg:px-12 text-center">
          ...
          <h1
            className="font-display text-6xl lg:text-8xl font-light text-pearl leading-none mb-6"
            style={{ fontFamily: "'Cormorant Garamond', serif" }}
          >
            Let&apos;s{" "}
            <em className="gold-text not-italic font-medium">Connect</em>
          </h1>
          <p className="text-mist text-lg max-w-xl mx-auto leading-relaxed">
            ...
            right solution — typically within 24 hours.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-16">
            <div className="lg:col-span-2">
              ...
              <div className="space-y-6 mb-12">
                {contactInfo.map((info) => (
                  ...
                  >
                    ...
                    <div>
                      <p
                        className="text-smoke text-xs tracking-widest uppercase mb-1"
                        style={{ fontFamily: "'DM Mono', monospace" }}
                      >
                        {info.label}
                      </p>
              ...
              >
                ...
                <p
                  className="text-pearl text-lg mb-4"
                  style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.25rem" }}
                >
                  &ldquo;Every inquiry is treated with the same professionalism and discretion 
                  as our ongoing client relationships.&rdquo;
                </p>
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <div className="flex flex-col items-center justify-center min-h-96 text-center border border-gold/20 p-16"
                ...
                >
                  ...
                  <h2
                    className="font-display text-4xl text-pearl mb-4"
                    style={{ fontFamily: "'Cormorant Garamond', serif" }}
                  >
                    Message{" "}
                    <em className="gold-text not-italic">Received</em>
                  </h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <label
                        className="block text-smoke text-xs tracking-widest uppercase mb-2"
                        style={{ fontFamily: "'DM Mono', monospace" }}
                      >
                        Full Name *
                      </label>
                  ...
                  <p
                    className="text-smoke text-xs text-center leading-relaxed"
                    style={{ fontFamily: "'DM Mono', monospace" }}
                  >
      ...
      <section className="py-24 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            >
              Frequently{" "}
              <em className="gold-text not-italic font-medium">Asked</em>
            </h2>
          </div>
          ...
          <div className="divide-y divide-white/5">
            {[
              ...
              },
              {
                ...
                a: "We are an India-based, Udyam-registered firm primarily serving Indian clients. For international inquiries, please contact us to discuss feasibility.",
              },
              {
                q: "Are your services available on a retainer basis?",
                a: "Yes. Many of our services — especially financial support and administrative assistance — can be engaged on a monthly retainer for continuous support.",
              },
              {
                q: "How do you ensure confidentiality?",
                a: "We operate under strict professional confidentiality standards. All client data is handled securely and never shared with third parties without explicit consent.",
              },
            ].map((faq, i) => (
